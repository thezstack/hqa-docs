        ...
        <div className="container">
          ...
          <div className="profile-card text-center">
            <div className="profile-info">
              ...
              <h2 className="hvr-underline-from-center">
                Sr. Lila Sharfeldin <span>Middle & High School Science</span>
              </h2>
              <div />
              <a href="mailto:"><i className="fa fa-envelope-o fa-2x" /></a>
            </div>
          ...
          <div className="profile-card text-center">
            <div className="profile-info">
              ...
              <h2 className="hvr-underline-from-center">
                Sr. Suha Subeh<span>Elementary English Language Arts</span>
              </h2>
              <div />
              <a href="mailto:"><i className="fa fa-envelope-o fa-2x" /></a>
            </div>
          ...
          <div className="profile-card text-center">
            <div className="profile-info">
              ...
              <h2 className="hvr-underline-from-center">
                Sr. Tabbasum Mughal
                <span>Elementary Math, Science & Social Studies</span>
              </h2>
              <div />
              <a href="mailto:"><i className="fa fa-envelope-o fa-2x" /></a>
            </div>
          ...
          <div className="profile-card text-center">
            <div className="profile-info">
              ...
              <h2 className="hvr-underline-from-center">
                Sr. Hind Ezzet<span>Phyiscal Education</span>
              </h2>
              <div />
              <a href="mailto:"><i className="fa fa-envelope-o fa-2x" /></a>
            </div>
          ...
          <div className="profile-card text-center">
            <div className="profile-info">
              ...
              <h2 className="hvr-underline-from-center">
                Br. Eric Abdulkhafed<span>Phyiscal Education</span>
              </h2>
              <div />
              <a href="mailto:"><i className="fa fa-envelope-o fa-2x" /></a>
            </div>
